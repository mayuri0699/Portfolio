...
#     about = models.TextField()
#     profilepic1 = models.ImageField(upload_to='profile', blank=True, null=True)
#     address = models.TextField(blank=True, null=True)
#     years_exp = models.CharField(max_length=15, blank=True, null=True)
...
#     service_name = models.CharField(max_length=100)
#     about_service = models.TextField()
#     service_pic = models.ImageField(upload_to='service_pictures', blank=True, null=True)
